        ...
        <div className="space-y-6 text-sm text-foreground/80 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              <li>Paid plans (Portfolio Pro $29/mo, Adviser Starter $99/mo, Adviser Pro $199/mo) include a 30-day free trial, one per account. Trial eligibility is determined solely by RealSight.</li>
